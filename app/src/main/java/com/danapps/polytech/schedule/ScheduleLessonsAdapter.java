...
import com.danapps.polytech.schedule.model.schedule.Building;
import com.danapps.polytech.schedule.model.schedule.Lesson;
import com.danapps.polytech.schedule.model.schedule.Teacher;
import com.danapps.polytech.schedule.model.schedule.TypeObj;
import com.danapps.polytech.schedule.utils.LessonUtils;
...
public class ScheduleLessonsAdapter extends RecyclerView.Adapter<ScheduleLessonsAdapter.ViewHolder> {
    ...
    private void bindLessonTime(@NonNull ViewHolder holder, @NonNull Lesson lesson) {
        ...
        if(lesson.getTimeStart() != null && lesson.getTimeEnd() != null) {
            timeString = String.format("%s-%s", lesson.getTimeStart().toString(), lesson.getTimeEnd().toString());
        }
    ...
    private void bindLesson(@NonNull ViewHolder holder, @NonNull Lesson lesson, int position) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        bindLesson(holder, lessons.get(position), position);
    }
